...
class _TutorDetailScreenState extends State<TutorDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return BlocListener<TutorDetailBloc, TutorDetailState>(
      listener: (_, state) {
        if (state is BookClassSuccess) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(S.of(context).bookSuccessfully)),
          );
        }

        if (state is BookClassFailed) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(S.of(context).bookError)),
          );
        }
      },
      child: Scaffold(
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                              ...
                              child: Row(
                                ...
                                children: [
                                  IconLabelWidget(
                                    ...
                                    onTap: () => tutorDetailBloc
                                        .add(FavoriteTutorEvent()),
                                  ),
                                  IconLabelWidget(
                            ...
                            const SizedBox(height: 12),
                            if (state.schedules?.isEmpty ?? false)
                              Center(
                                child: Text(
                                  S.of(context).noScheduleTutor,
