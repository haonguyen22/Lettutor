      ...
      listener: (_, state) {
        if (state is UpdateUserProfileSuccess) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(S.of(context).updateProfileSuccess),
        ...
        if (state is UpdateUserProfileFailed) {
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text(S.of(context).updateProfileFailed),
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: MultiChoiceWidget(
                      ...
                      listLabel:
                          testPreparations.map((e) => e["name"]).toList(),
                      onTap: (index) {
                        final value =
                            Topic.fromJson(testPreparations[index]).id;
                        setState(() {
