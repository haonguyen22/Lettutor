...
class _ScheduleService implements ScheduleService {
  ...
  @override
  Future<void> postBookAClass({required Map<String, dynamic> body}) async {
  ...
  Future<CancelBookedResponse?> cancelBookedClass(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(
        _setStreamType<CancelBookedResponse>(Options(
      method: 'DELETE',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = _result.data == null
        ? null
        : CancelBookedResponse.fromJson(_result.data!);
    return value;
  }
