...
abstract class _CourseModel extends CourseModel {
  const factory _CourseModel(
      ...
      final String? createdAt,
      final String? updatedAt,
      final List<TopicCourseModel>? topics}) = _$_CourseModel;
