...
/// @nodoc
abstract class _$$_TutorModelCopyWith<$Res>
    implements $TutorModelCopyWith<$Res> {
  factory _$$_TutorModelCopyWith(
          _$_TutorModel value, $Res Function(_$_TutorModel) then) =
      __$$_TutorModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'avatar') String? imageUrl,
...
/// @nodoc
class __$$_TutorModelCopyWithImpl<$Res>
    extends _$TutorModelCopyWithImpl<$Res, _$_TutorModel>
    implements _$$_TutorModelCopyWith<$Res> {
  __$$_TutorModelCopyWithImpl(
      _$_TutorModel _value, $Res Function(_$_TutorModel) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_TutorModel extends _TutorModel {
  const _$_TutorModel(
      {@JsonKey(name: 'avatar') this.imageUrl,
      this.name,
      this.id,
      this.userId,
      this.country,
  ...
  _$$_TutorModelCopyWith<_$_TutorModel> get copyWith =>
      __$$_TutorModelCopyWithImpl<_$_TutorModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_TutorModelToJson(
      this,
    );
  }
}
...
abstract class _TutorModel extends TutorModel {
  const factory _TutorModel(
      {@JsonKey(name: 'avatar') final String? imageUrl,
      final String? name,
      final String? id,
      final String? userId,
      final String? country,
