...
class _$_User implements _User {
  ...
  @override
  String toString() {
    return 'User(id: $id, email: $email, name: $name, avatar: $avatar, country: $country, phone: $phone, language: $language, birthday: $birthday, requireNote: $requireNote, level: $level, learnTopics: $learnTopics, testPreparations: $testPreparations, studySchedule: $studySchedule)';
  }
